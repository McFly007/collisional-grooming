...
namespace grid_octree {
	...
	class Octree {
		...
		GridPoint *data;   //! Data point to be stored at a node
	...
	void set_all_Weights(const float weight) {
		...
		void getPointsInsideBox(const Vec3& bmin, const Vec3& bmax, std::vector<GridPoint*>& results) {
